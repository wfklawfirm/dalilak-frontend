    ...
    <main id="main-content" dir={isAr ? 'rtl' : 'ltr'} style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div>
            ...
            <p id="reg-password-hint" style={{ margin: '0 0 6px', fontSize: 11, color: 'var(--text-3)' }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <button type="button" tabIndex={-1}
                ...
                style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text-3)', padding: 0, display: 'flex', alignItems: 'center' }}>
                {showPass
          ...
          <p style={{ fontSize: 10.5, color: 'var(--text-3)', textAlign: 'center', margin: '2px 0 0', lineHeight: 1.6 }}>
      ...
      <p style={{ marginTop: 18, fontSize: 11, color: '#B8B2AA', textAlign: 'center' }}>
        <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4, justifyContent: 'center' }}>
          <svg aria-hidden="true" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="var(--text-3)" strokeWidth="1.8"><path strokeLinecap="round" strokeLinejoin="round" d="M3 6l9 4 9-4M3 6v12l9 4m0-12v12m0-12L12 2l9 4M21 6v12l-9 4"/></svg>
