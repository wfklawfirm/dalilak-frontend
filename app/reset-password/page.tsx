  ...
  return (
    <>
      ...
      <div style={{ marginTop: 14, textAlign: 'center', fontSize: 13, color: '#9C8E80' }}>
        <Link href="/forgot-password" style={{ color: '#8B1A1A', fontWeight: 700, textDecoration: 'none' }}>
          طلب رمز جديد
        </Link>
      </div>
    </>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <Suspense fallback={<div style={{ textAlign: 'center', color: '#9C8E80', fontSize: 13 }}>تحميل...</div>}>
          <ResetForm />
        </Suspense>
      </div>
