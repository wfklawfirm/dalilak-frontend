      ...
      {!compact && (
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{ height: 8, background: '#EAE4D9', borderRadius: 4, overflow: 'hidden' }}>
            <div style={{ height: '100%', width: `${progressPct}%`, background: progressPct >= 80 ? 'linear-gradient(90deg, #78350F, #B45309)' : progressPct >= 50 ? 'linear-gradient(90deg, #B8860B, #CA8A04)' : 'linear-gradient(90deg, #6b2737, #8B1A1A)', borderRadius: 4, transition: 'width 0.5s ease' }} />
          </div>
