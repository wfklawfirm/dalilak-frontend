...
git diff --cached --quiet || git commit -m "feat: توسعة أرشيف الوثائق الرسمية — إكمال OCR رفع العدد من 4378 إلى 5303 وثيقة حكومية حقيقية (19 جهة)، مرفوعة أيضاً لقاعدة Qdrant"
