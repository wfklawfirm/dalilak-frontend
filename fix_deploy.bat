...
REM 5. Commit
git commit -m "fix: comprehensive link audit across all services and forms - fixed 15 dead .gov.lb domains in allServices.ts (interior/mof/isa/moc/moyslebanon/pressorder/refugees/regie/southcouncil/conseilideal/cadastre/mfa) with verified live replacements (moim/finance/insurancecommission/tra/minijes/pressorderlebanon/ministryofdisplaced/regie.com.lb/councilforsouth/statecouncil), fixed 2 malformed concatenated-URL fields, fixed mislabeled water-ministry link; fixed 3 dead domains + 1 dead PDF attachment in curated FORMS_DATA (procedures.ts); added 1 verified missing form link (MBK9-08) to allTransactions.ts; WAYBACK AUDIT COMPLETE (2026-07-17): all 770 unique Wayback form links individually re-verified against Internet Archive (CDX + availability API, fully serial, no rate-limit violations) - 688 confirmed FAKE (~89%%), 81 confirmed REAL, 1 non-Wayback dead link found; WAYBACK FIX APPLIED (2026-07-17): replaced all 695 fake/dead pdfUrl entries in allTransactions.ts (_P dict, backup saved as allTransactions.ts.bak_before_wayback_fix_*) with verified-live official ministry forms/e-services pages (economy.gov.lb, socialaffairs.gov.lb, labor.gov.lb, customs.gov.lb, agriculture.gov.lb, moph.gov.lb, omsar.gov.lb, finance.gov.lb, lebarmy.gov.lb, culture.gov.lb, mehe.gov.lb, moim.gov.lb, mot.gov.lb, tra.gov.lb, industry.gov.lb, solidere.com, gdcoops.gov.lb, ebml.gov.lb, justice.gov.lb, general-security.gov.lb, tmo.gov.lb, mopw.gov.lb, lrc.gov.lb, libnor.gov.lb, portdebeyrouth.com, ministryinfo.gov.lb, ministryofdisplaced.gov.lb - 27 domains across 35 ministry categories, each individually fetch-verified) rather than deleting the hasForm feature - hasForm flags and _R array left untouched; 0 REAL wayback links touched; esbuild+UTF8 verified clean after edit; total 367 services across 58 categories"
